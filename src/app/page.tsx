...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      'Every asset on our platform is verified by out team to ensure our highest quality standards. Not happy? We offer a 30-day refund guarentee.',
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to AssetFox. Every asset on our platform is verified by our
